...
const PokeLocation = () => {
  ...
  let content = data ? (
    <section className="text-xs md:text-base w-3/4 md:w-1/2 lg:w-1/3 h-auto md:h-1/3 flex flex-col p-1 justify-center items-center text-black dark:text-slate-200  bg-slate-200 dark:bg-slate-900 bg-opacity-50 rounded-md border-2 border-black dark:border-yellow-500 shadow-md flex-shrink-0 overflow-auto">
      {data.length === 0 ? (
        ...
        <ul className="w-full h-auto p-4 md:mt-8 text-xs md:text-base bg-slate-200 bg-opacity-50 dark:bg-slate-950 rounded-md flex flex-col items-center justify-center">
